...
import net.aknell.waltuhmod.screen.slot.ModFuelSlot;
import net.aknell.waltuhmod.screen.slot.ModResultSlot;
...
public class SynthesizerScreenHandler extends ScreenHandler {
    ...
    public SynthesizerScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
        super(ModScreenHandlers.SYNTHESIZER_SCREEN_HANDLER, syncId);
